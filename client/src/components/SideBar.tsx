...
const SideBar: FunctionComponent<SideBarProps> = () => {
    ...
    return ( 
      ...
      <div className=" flex p-3 mt-8  gap-3">
            <div className=" flex flex-col justify-center  gap-8 ">
              <div className=" cursor-pointer"><HomeLogo  /></div>
                <div className=" cursor-pointer"><RegisterLogo  /></div>
                <div className=" cursor-pointer"><LoginLogo /></div>
            </div>
            <div className=" flex flex-col justify-center gap-8 ">
              <div className={` ${!expand && "hidden"} text-white text-[1.2rem] cursor-pointer font-medium`}>Home</div>
